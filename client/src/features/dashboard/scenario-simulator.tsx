  ...
  return (
    <Card>
      ...
      <div className="flex flex-wrap items-end gap-4">
        ...
        <div className="flex flex-1 items-center gap-5 rounded-xl bg-ember-50 px-5 py-3">
          <div>
            <p className="text-[11px] text-graphite-600/70">Predicted Impact (Next 7 Days)</p>
          </div>
          <div className="flex items-center gap-2">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-white text-ember-600">
          ...
          <div className="flex items-center gap-2">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-white text-sky-500">
              <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
